...
OUTPUTS: list[dict[str, Any]] = [
    {
        ...
        "range": [0.0, 1.0],
        "semantics": (
            "P(switches on the heat-shock-element reporter in the Tox21 qHTS "
            "screen). The assay reads the response, not the protein that misfolded"
        ),
    ...
    },
    {
        ...
        "semantics": (
            ...
            "compound scoring high on both readouts lit the reporter in a cell that "
            "was also dying"
        ),
        "missing": "NaN when RDKit cannot parse the input SMILES",
    },
