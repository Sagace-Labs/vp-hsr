"""Measure a version under an evaluation protocol.
    ...
    python -m vp_hsr.evaluate --version v1
...
from vp_hsr.train import OUTPUT_LABELS
...
def evaluate_version(
    ...
    *,
    ...
    table = hsr_data.example() if use_example else hsr_data.load()
    ...
    primary = scored[hsr_contract.PRIMARY]
...
def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(prog="python -m vp_hsr.evaluate")
    ...
    version = args.version or vp_hsr.current_version()
